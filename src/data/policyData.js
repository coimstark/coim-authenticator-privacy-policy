...
import {
  ...
  IoServerOutline,
  IoShieldHalfOutline,
  IoPersonOutline, // Changed from IoChildOutline
  IoHelpCircleOutline,
  IoGlobeOutline,
  IoMailOutline,
  IoRefreshOutline
...
// Alternative: If you specifically want a child icon, import from Font Awesome
...
export const privacyPolicySections = [
  ...
  },
  {
    ...
    content: `
      ...
      <p>To exercise any of these rights or if you have questions, please contact us at kwcoim@gmail.com.</p>
    `
  },
  {
    title: "Children's Privacy",
    icon: <IoPersonOutline />, // Changed from IoChildOutline to IoPersonOutline
    content: `
      ...
      <p>If we discover that we have collected personal information from a child under 13, we will promptly delete that information. If you believe we might have any information from or about a child under 13, please contact us at kwcoim@gmail.com.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p><em>Last updated: March 5, 2025 14:54:57 (UTC)</em></p>
    `
  },
  {
    title: "Contact Us",
    ...
    content: `
      ...
      <ul>
        <li>By email: kwcoim@gmail.com</li>
        <li>By visiting our website: https://coimstark.github.io/coim-authenticator-privacy-policy</li>
      </ul>
      <p>For security concerns or data breach reports, please contact us immediately at kwcoim@gmail.com.</p>
      <p>For accessibility issues related to this privacy policy, please email kwcoim@gmail.com.</p>
